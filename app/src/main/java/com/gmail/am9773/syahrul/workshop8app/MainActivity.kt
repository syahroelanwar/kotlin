...
package com.gmail.am9773.syahrul.workshop8app
...
class MainActivity : AppCompatActivity() {
    ...
    private class ProductViewHolder internal constructor(parent: ViewGroup) : RecyclerView.ViewHolder(LayoutInflater.from(parent.context).inflate(
        ...
        init {
            ...
            yearView = itemView.findViewById(R.id.year) as TextView
            desView = itemView.findViewById(R.id.des) as TextView
        ...
        internal fun bind(product: ProductEntry, imageRequester: ImageRequester) {
            ...
            yearView.text = product.year
            desView.text = product.description
        }
    }
